...
#ifndef __GFE_FitOrthogonalPlane_h__
#define __GFE_FitOrthogonalPlane_h__

#include "GFE/GFE_FitOrthogonalPlane.h"
...
class GFE_FitOrthoPlane : public GFE_AttribFilter {
...
}; // End of class GFE_FitOrthoPlane
