...
#ifndef __GFE_DelaunayTriangulate_h__
#define __GFE_DelaunayTriangulate_h__
...
class GFE_DelaunayTriangulate : public GFE_AttribFilter {
...
}; // End of class GFE_DelaunayTriangulate
