...
#ifndef __GFE_MatchQuadrant_h__
#define __GFE_MatchQuadrant_h__

#include "GFE/GFE_MatchQuadrant.h"
...
class GFE_MatchQuadrant : public GFE_AttribFilter {
...
}; // End of class GFE_MatchQuadrant
