...
#ifndef __GFE_CurveDirectionSoftBlend_h__
#define __GFE_CurveDirectionSoftBlend_h__
...
class GFE_CurveDirSoftBlend : public GFE_AttribFilter {
...
}; // End of class GFE_CurveDirSoftBlend
