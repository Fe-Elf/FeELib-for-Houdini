...
#include "SOP_FeE_HeightFieldProject_2_0.h"


#include "SOP_FeE_HeightFieldProject_2_0.proto.h"
...
PRM_Template*
SOP_FeE_HeightFieldProject_2_0::buildTemplates()
{
    static PRM_TemplateBuilder templ("SOP_FeE_HeightFieldProject_2_0.C"_sh, theDsFile);
    if (templ.justBuilt())
    {
...
const UT_StringHolder SOP_FeE_HeightFieldProject_2_0::theSOPTypeName("FeE::hfProject::2.0"_sh);

void
newSopOperator(OP_OperatorTable* table)
{
    OP_Operator* newOp = new OP_Operator(
        SOP_FeE_HeightFieldProject_2_0::theSOPTypeName,
        "FeE Height Field Project",
        SOP_FeE_HeightFieldProject_2_0::myConstructor,
        SOP_FeE_HeightFieldProject_2_0::buildTemplates(),
        1,
        2,
        nullptr,
        ...
        nullptr,
        1,
        "Five elements Elf/HeightField");

    newOp->setIconName("SOP_heightfield_project");
...
public:
    ...
    virtual UT_StringHolder name() const { return SOP_FeE_HeightFieldProject_2_0::theSOPTypeName; }
...
const SOP_NodeVerb *
SOP_FeE_HeightFieldProject_2_0::cookVerb() const 
{ 
