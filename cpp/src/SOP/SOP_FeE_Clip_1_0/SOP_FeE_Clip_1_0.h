...
#ifndef __SOP_FeE_Clip_1_0_h__
#define __SOP_FeE_Clip_1_0_h__
...
class SOP_FeE_Clip_1_0 : public SOP_Node
{
public:
    static PRM_Template *buildTemplates();
    static OP_Node *myConstructor(OP_Network *net, const char *name, OP_Operator *op)
    {
        OP_Node* newOp = new SOP_FeE_Clip_1_0(net, name, op);
...
protected:
    SOP_FeE_Clip_1_0(OP_Network *net, const char *name, OP_Operator *op)
